...
from det3d.datasets.nuscenes.camera.common import INTERPOLATION, get_view_matrix, get_pose, get_split


@DATASETS.register_module
class NuScenesCameraDataset(PointCloudDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(NuScenesCameraDataset, self).__init__(
        ...
        self.CAMERAS = ['CAM_FRONT_LEFT', 'CAM_FRONT', 'CAM_FRONT_RIGHT',
               'CAM_BACK_LEFT', 'CAM_BACK', 'CAM_BACK_RIGHT']
        self.camera_rig = list(range(len(self.CAMERAS)))
    ...
    def get_sensor_data(self, idx):
        ...
        res = self.parse_sample_record(sample_record, self.camera_rig)
        print(res.keys())
        res.update({
            "lidar": {
                "type": "lidar",
    ...
    def evaluation(self, detections, output_dir=None, testset=False):
        ...
        for det in dets:
            ...
            boxes = _lidar_nusc_box_to_global(self.nusc, boxes, det["metadata"]["token"])
